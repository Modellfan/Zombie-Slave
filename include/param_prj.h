...
#define PARAM_LIST                                                                        \
   ...
   VALUE_ENTRY(vacuum_pump_insufficient, YESNO, 2111)                                     \
                                                                                          \
   PARAM_ENTRY(CAT_TESLA_DCDC, dcdc_can, CAN_DEV, 0, 1, 1, 107)                           \
   ...
   VALUE_ENTRY(BMS_BalancingStatus, BMS_BALANCING_STATUS, 2229)                           \
   VALUE_ENTRY(BMS_AvgEnergyPerHour, "kW", 2230)                                          \
   VALUE_ENTRY(BMS_RemainingTime, "s", 2231)                                              \
   ...
   PARAM_ENTRY(CAT_LVDU, LVDU_force_vcu_shutdown_delay, "ms", 0, 60000, 1000, 167)       \
...
#define BMS_DTC_FLAGS \
    "0=NONE,1=DTC_BMS_CAN_SEND_ERROR,2=DTC_BMS_CAN_INIT_ERROR,4=DTC_BMS_PACK_FAULT," \
    "8=DTC_BMS_CONTACTOR_FAULT,16=DTC_BMS_SHUNT_FAULT,32=RESERVED_BIT5," \
    "64=RESERVED_BIT6,128=RESERVED_BIT7"
...
#define CONT_DTC_FLAGS \
    "0=UNAVAILABLE_FROM_0x41C_BYTE5_CURRENT_FW"
...
#define VEHICLE_STATE "-1=INVALID,0=SLEEP,1=STANDBY,2=HV_CONNECTING,3=HV_DISCONNECTING,4=READY,5=CONDITIONING,6=DRIVE,7=CHARGE,8=ERROR,9=LIMP_HOME,10=FORCE_VCU_SHUTDOWN"
